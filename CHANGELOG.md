...
### Released
- Published **agent-router** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **agent-router**.
...
- That insight became the basis for **agent-router**.
